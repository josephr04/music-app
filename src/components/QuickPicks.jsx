...
export default function QuickPicks() {
    ...
    return (
        <>
            ...
            <div className='w-full px-6 grid grid-flow-col grid-rows-4 overflow-x-auto whitespace-nowrap gap-4 gap-x-20 '>
                {songs.map((song) => (
                    <div key={song.id} className="flex items-center w-64 cursor-pointer space-x-4">
                        <div className="w-16 h-16 flex-shrink-0 rounded-lg bg-green-500 hover:bg-slate-700 shadow-md transition-all">
                        </div>
