        ...
        <div className='flex flex-col justify-between h-5/6'>
          <ul className='p-2'>
            {options.map(({name, icon, section}) => (
              <li key={name} onClick={toggleMenu} className="active:bg-gray-600 rounded-lg cursor-pointer">
          ...
          <h2 className='text-xs text-center mb-4'>© Copyright 2024. Made by Joseph Rosas.</h2>
        </div>
      </div>
    </>
  );
